...
def main():
	...
	master.channels[0].addWave(440, vol = 0.8)
	...
	#av, al, dl, sv, sl, rl
	master.channels[0].FX.append(env(1, 0.2, 0.005, 0.6, 0.3, 0.4, BS = bs, FPS = 44100))
	
	#Band_Len, Delay, Mix = 0.5, Fade = 2
	master.channels[0].FX.append(echo(88200, 0.5, Fade = 5, BuffSize = bs, FPS = 44100))
	"""
	...
	master.channels[0].staticConts.append(LFO(5, master.channels[0].inputs[1].updateFreq,
										  ...
										  bs, MaxVal = 400, MinVal = 420, waveType = "sine"))
